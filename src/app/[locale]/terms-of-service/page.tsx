...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Doom By Fate Wiki",
    description: "Read the Terms of Service for Doom By Fate Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    keywords: [
      'terms of service',
      "Doom By Fate Wiki terms",
      'user agreement',
      'legal terms',
      'usage policy',
    ],
    ...
    openGraph: {
      ...
      title: "Terms of Service - Doom By Fate Wiki",
      description: "Terms and conditions for using Doom By Fate Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Doom By Fate Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Doom By Fate Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Doom By Fate Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Doom By Fate Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Doom By Fate". Our services include, but are not limited to:
            </p>
            <ul>
            ...
            <p>
              <strong>Important:</strong> Doom By Fate Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official developers of Doom By Fate. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Doom By Fate Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of Doom By Fate. We use such
            ...
            <ul>
              ...
              <li><strong>Game Changes:</strong> Roblox game updates may change game content without notice. We are not responsible for content changes.</li>
            </ul>
            <p>
            ...
            <p>
              ...
              you and Doom By Fate Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@doombyfate.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@doombyfate.wiki</a>
            </p>
            <p>
